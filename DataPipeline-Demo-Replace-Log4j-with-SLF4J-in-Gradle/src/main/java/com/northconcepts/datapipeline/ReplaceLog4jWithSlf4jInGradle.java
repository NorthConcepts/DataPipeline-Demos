/*
 * Copyright (c) 2006-2021 North Concepts Inc.
 * 
...
public class ReplaceLog4jWithSlf4jInGradle {

    private static final Logger logger = LoggerFactory.getLogger(ReplaceLog4jWithSlf4jInGradle.class);

    private static final String ACCESS_KEY = "YOUR ACCESS KEY";
    private static final String SECRET_KEY = "YOUR SECRET KEY";

    public static void main(String[] args) throws Throwable{
        logger.info("Example log from {}", ReplaceLog4jWithSlf4jInGradle.class.getSimpleName());

        URL resource = ReplaceLog4jWithSlf4jInGradle.class.getClassLoader().getResource("read_parquet_file.parquet");
